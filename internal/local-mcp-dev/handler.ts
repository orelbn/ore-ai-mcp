...
async function readResolvedConnection(
	request: Request,
...
export function createLocalMcpDevFetchHandler(
	runtimeConfig: LocalDevRuntimeConfig,
) {
...
export function logStartup(runtimeConfig: LocalDevRuntimeConfig): void {
	...
	console.log(
		`Local MCP Dev running at http://127.0.0.1:${runtimeConfig.port} (${targetSummary})`,
	);
}
