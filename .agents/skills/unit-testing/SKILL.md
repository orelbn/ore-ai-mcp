...
Always produce these three temporary test artifacts before writing tests. Once testing is completed, remove the artifacts.
...
- **External boundary isolation:** What to mock or fake at network, filesystem, or service boundaries.
...
- Cover happy path, boundary conditions, and invalid or adversarial inputs.
...
- Strengthen assertions that only check existence or success.
...
- **Determinism:** Is the result independent of time, randomness, or external state?
